const sceneConfig = {
  ...
  scenes: {
    'a-wall': { title: 'A区｜从一头牛出发 / 阿牧是谁 / 6.9米', type: 'equirectangular', panorama: 'assets/panoramas/a-wall-empty.png', hfov: 105, yaw: 0, pitch: 0 },
    'b-wall': { title: 'B区｜技术闭环 / 阿牧如何解决问题 / 8.4米', type: 'equirectangular', panorama: 'assets/panoramas/b-wall-empty.png', hfov: 105, yaw: 0, pitch: 0 },
    ...
    'e-foyer': { title: 'E区｜企业文化 / 产业责任 / 2.3米', type: 'equirectangular', panorama: 'assets/panoramas/e-foyer-empty.png', hfov: 105, yaw: 0, pitch: 0 }
  }
};
